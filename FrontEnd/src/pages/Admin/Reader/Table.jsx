              ...
              data.map((item, index) => (
                ...
                >
                  ...
                  <td class="whitespace-nowrap px-6 py-4 ">
                    {item.gender ? (
                      <span class="px-2 py-1 font-semibold leading-tight text-indigo-300 bg-indigo-100 rounded-md">
                        {" "}
                        Nam{" "}
                      </span>
                    ) : (
                      <span class="px-2 py-1 font-semibold leading-tight text-rose-400 bg-rose-100 rounded-md">
                        {" "}
                        Nữ{" "}
                      </span>
                    )}
